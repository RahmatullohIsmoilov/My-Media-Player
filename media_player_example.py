...
class Window(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Rahmatulloh's Media Player")
    ...
    def set_speed(self):
        if self.mediaPlayer.playbackRate() == 2.0:
            ...
            self.setWindowTitle("Rahmatulloh's Media Player - Normal Speed")
            QTimer.singleShot(300, lambda: self.setWindowTitle("Rahmatulloh's Media Player"))
        else:
            self.mediaPlayer.setPlaybackRate(2.0)
            self.setWindowTitle("Rahmatulloh's Media Player - 2x Speed")
            QTimer.singleShot(300, lambda: self.setWindowTitle("Rahmatulloh's Media Player"))
